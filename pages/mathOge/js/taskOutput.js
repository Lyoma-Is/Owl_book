...
<option value="taskTwentyTwoPage.html">22. Функции и их свойства. Графики функций.</option>
<option value="taskTwentyThreePage.html">23. Геометрические задачи на вычисление.</option>
<option value="taskTwentyFourPage.html">24. Геометрические задачи на доказательство.</option>
...
document.addEventListener('click', function(e) {
  if (e.target && e.target.id === 'text-inform-button') {
    ...
    const PAGE_TO_KEC = {
      ...
      'taskTwentyTwoPage.html': 22,
      'taskTwentyThreePage.html': 23,
      'taskTwentyFourPage.html': 24,
      'taskTwentyFivePage.html': 25
    };
    ...
    const KEC_DESCRIPTIONS = {
      ...
      22: "КЭС:	2.4 Алгебраическая дробь.<br>КЭС: 5.1 Функция, способы задания функции. График функции. Область определения и множество значений функции. Нули функции. Промежутки знакопостоянства. Промежутки монотонности функции. Максимумы и минимумы функции. Наибольшее и наименьшее значение функции на промежутке.",
      23: "КЭС: 7.2 Треугольник.<br>КЭС: 7.3 Многоугольники.<br>КЭС: 7.4 Окружность и круг.<br>КЭС: 7.5 Измерение геометрических величин.",
      24: "КЭС: 7.2 Треугольник.<br>КЭС: 7.3 Многоугольники.<br>КЭС: 7.4 Окружность и круг.",
      25: "КЭС: 7.2 Треугольник.<br>КЭС: 7.3 Многоугольники.<br>КЭС: 7.4 Окружность и круг.<br>КЭС: 7.5 Измерение геометрических величин."
