 ...
 //   answerBlock += endTask();
    ...
    if (taskKey === 'onefive'){
      ...
      function reshOneFive(item){
        if (item === 712){
          return `
          • пакет минут, включающий 300 минут исходящих вызовов на номера, зарегистрированные на территории РФ;<br>
           • пакет интернета, включающий 3 гигабайта мобильного интернета;<br>
           • пакет SMS, включающий 120 SMS в месяц;<br>
           • безлимитные бесплатные входящие вызовы.<br>
          Сверх пакета тарифа<br>
          Исходящие вызовы 3 руб./мин.<br>
          Мобильный интернет (пакет) 90 руб. за 0,5 ГБ<br>
          SMS 2 руб./шт.<br>
          В декабре было использовано 2,25 ГБ и 350 мин. Больше тарифа на 50 мин и 1 ГБ.<br>
          50 • 3 = 150р<br>
          350 + 150 = 500р.<br>
          `
        }
          ...
          Мобильный интернет (пакет) 90 руб. за 0,5 ГБ<br>
          SMS 2 руб./шт.<br>
          В апреле было использовано 4 ГБ и 350 мин. Больше тарифе на 50 мин.<br>
          50 • 3 = 150р<br>
          за 0.5 ГБ 90р, за 1 ГБ 180р.<br>
          350 + 150 + 180 = 680р.<br>
          `
        }
        else if (item === 710){
          ...
          Мобильный интернет (пакет) 90 руб. за 0,5 ГБ<br>
          SMS 2 руб./шт.<br>
          В августе было использовано 1,5 ГБ и 325 мин. Больше тарифе на 25 мин.<br>
          25 • 3 = 75р<br>
          350 + 75 = 425р.<br>
          `
        }
          ...
          Мобильный интернет (пакет) 90 руб. за 0,5 ГБ<br>
          SMS 2 руб./шт.<br>
          В июле было использовано 1 ГБ и 375 мин. Больше тарифе на 75 мин.<br>
          75 • 3 = 225р<br>
          350 + 225 = 575р.<br>
          `
        }
          ...
          Мобильный интернет (пакет) 90 руб. за 0,5 ГБ<br>
          SMS 2 руб./шт.<br>
          В июне было использовано 3 ГБ и 325 мин. Больше тарифе на 25 мин.<br>
          25 • 3 = 75р<br>
          350 + 75 = 425р.<br>
          `
        }
          ...
          Мобильный интернет (пакет) 90 руб. за 0,5 ГБ<br>
          SMS 2 руб./шт.<br>
          В феврале было использовано 3,5 ГБ и 275 мин. Больше 0,5 ГБ.<br>
          за 0,5 ГБ интернета 90р<br>
          350 + 90 = 440р.<br>
          `
        }
        else { return `...`}
      ...
      switch(typeTask){
        ...
        case 5:
          ...
          Площадь, занятая сараем, равна 24 кв. м. Жилой дом находится в глубине территории и обозначен на плане цифрой 6. 
          ...
          На участке также растут ели. В центре участка расположен цветник.<br>
          Все дорожки внутри участка имеют ширину 1 м и вымощены тротуарной плиткой размером 50 cм×50 cм. 
          Перед гаражом и между домом и беседкой имеются площадки площадью 40 и 16 кв. м соответственно, вымощенные такой же плиткой. 
          К домохозяйству подведено электричество. Имеется магистральное газоснабжение.
          ` 
            :
            ``}   
        ...
        case 6:
          ...
          ${task === 61 ? 
            ...
            В конце каникул дедушка на машине собирается отвезти Таню на автобусную станцию, которая находится в деревне Богданово. 
           ...
           от Горюново до Ванютино — 15 км, от Ванютино до Жилино — 9 км, а от Жилино до Богданово — 12 км.
            ...
            : task === 62 ? 
            `
            Саша летом отдыхает у дедушки в деревне Масловка. В субботу они собираются съездить на велосипедах в село Захарово в магазин. 
            Из деревни Масловка в село Захарово можно проехать по прямой лесной дорожке. Есть более длинный путь: по прямолинейному шоссе через деревню Вёсенка
            ...
            : task === 63 ? 
            `
            Гриша летом отдыхает у дедушки в деревне Осиновка. В субботу они собираются съездить на велосипедах в село Николаево в магазин. 
          ...
          : task === 65 ? 
            `
            Володя летом отдыхает у дедушки в деревне Ёлочки. В воскресенье они собираются съездить на машине в село Кленовое. 
            Из деревни Ёлочки в село Кленовое можно проехать по прямой грунтовой дороге. Есть более длинный путь: по прямолинейному шоссе через деревню Сосенки до деревни Жуки, 
          ...
          : task === 66 ? 
            `
            Полина летом отдыхает у дедушки в деревне Ясная. В четверг они собираются съездить на велосипедах в село Майское в магазин. 
            Из деревни Ясная в село Майское можно проехать по прямой лесной дорожке. Есть более длинный путь: по прямолинейному шоссе через деревню Камышёвка до деревни Хомяково, 
            где нужно повернуть под прямым углом налево на другое шоссе, ведущее в село Майское. 
...
Из деревни Дивная в село Ольгино можно проехать по прямой лесной дорожке. Есть более длинный путь: по прямолинейному шоссе через деревню Калиновка до села Ровное, где нужно повернуть под прямым углом направо на другое шоссе, ведущее в село Ольгино. Есть и третий маршрут:
 ...
 со скоростью 40 км/ч. На плане изображено взаимное расположение населённых пунктов, длина стороны каждой клетки равна 2 км.
          ...
          answerBlock +=` 
            ...
            <table class="iksweb">
              ...
              `
              : task === 62 || task === 63 || task === 64 || task === 65 || task === 66 || task === 67 || task === 68 || task === 69  || task === 691 || task === 692 ? 
              `
    ...
    if (taskKey === 'fifteen'){
      ...
      function reshFifteen(item){
        if (item === 11){
          ...
          return `
          Треугольник ABC равносторонний, следовательно ∠A = ∠C ${h10()}
          ∠A + ∠C = 180° — ∠ABC = 180° — ${task1[0]}° = ${180-task1[0]}° ${h10()}
          ∠BCA = ${180-task1[0]}° / 2 = ${(180-task1[0])/2}°
            
          `
        }
        else if (item === 13){
          return `
          AD — биссектриса угла BAC и делит угол пополам.${h10()}
          ∠BAC = ${task1[0]}° ${h10()}
          ∠BAD = ∠BAC / 2 = ${task1[0]}° / 2 = ${task1[0]/2}°
          `
        }
        else if (item === 14 || item === 15){
          return `
          Сумма углов треугольника равна 180°${h10()}
          Один из углов прямоугольника треугольника равна 90°, следовательно сумма острых углов прямоугольника треугольника равна 90°${h10()}
    ...
    if (taskKey === 'seventeen'){
      ...
      function reshSeventeen(item){
        if (item === 11){
          ...
          return `
          Высота трапеции образует прямоугольный треугольник, у прямоугольного треугольника один угол 90°, второй угол 45° соответственно третий угол тоже 45°.
          ${h10()} 
          Отсюда прямоугольный треугольник так же равнобедренный.
          ${h10()} 
          <img style="display: block;  width: 19em; " src="../../pages/mathOge/img/task17/17_trap_2.png">
          ${h10()} 
          ${task1[0] === 2 ?
            `
            Высота: BE = ${task1[1]}
            ${h10()}
            Меньшее основание: BC = ${task1[2]}
            ${h10()}
            AE = FD = BE = ${task1[1]}
            ${h10()}
            EF = BC = ${task1[2]}
            ${h10()}
            Большее основание: AD = AE + EF + FD
            ${h10()}
            AD = ${task1[1]} + ${task1[2]} + ${task1[1]} = ${task1[1]+task1[2]+task1[1]}
            `
            :
            `
            Высота: BE = ${task1[1]}
            ...
            AE = FD = BE = ${task1[1]}
            ${h10()}
            EF = AD — AE — FD = ${task1[2]} — ${task1[1]} — ${task1[1]} = ${task1[2]-task1[1]-task1[1]}
            ${h10()}
            Меньшее основание: BC = EF = ${task1[2]-task1[1]-task1[1]}
          ...
          <img style="display: block;  width: 19em; " src="../../pages/mathOge/img/task17/17_trap_2.png">
          ${h10()} 
          Меньшее основании: a = ${task1[0]}
          ${h10()} 
          Большее основании: b = ${task1[1]}
          ${h10()} 
          Высота: h = (b — a) / 2 = (${task1[1]} — ${task1[0]}) / 2 = ${(task1[1]-task1[0])/2}
          ${h10()}
          Площадь трапеции: S = ${drobNum(`a + b`, 2)} • h = ${drobNum(`${task1[0]} + ${task1[1]}`, 2)} • ${(task1[1]-task1[0])/2} = 
          ${drobNum(`${task1[0]+task1[1]}`, 2)} • ${(task1[1]-task1[0])/2} = ${((task1[0]+task1[1])/2)*((task1[1]-task1[0])/2)}
          `
        }
        else if (item === 31){
          return `
          Пересечение диагоналей делит диагонали пополам 
          ${h10()}
          Если BD = ${task1[1]}, то DO равна половине BD
          ${h10()}
          DO = BD / 2 = ${task1[1]}  / 2 = ${task1[1]/2}
          `
        }
        else if (item === 32){
          return `
          Биссектриса угла А делит угол А пополам, отсюда угол А равен: ∠А = 2 • ${task1[0]}° = ${task1[0]*2}°
          `
        }
        else if (item === 33){
          return `
          ...
          ${h10()}
          Меньший угол параллелограмма равен: ${task1[0]}° + ${task1[1]}° = ${task1[0]+task1[1]}° 
          ${h10()}
          Больший угол параллелограмма равен: 180° — ${task1[0]+task1[1]}° = ${180-task1[0]-task1[1]}°
          `
        }
        else if (item === 34){
          return `
          Сумма углов прилежащих к одной стороне параллелограмма равна 180°.
          ${h10()}
          Больший угол параллелограмма равен: ${task1[0]}° + ${task1[1]}° = ${task1[0]+task1[1]}° 
          ${h10()}
          Меньший угол параллелограмма равен: 180° — ${task1[0]+task1[1]}° = ${180-task1[0]-task1[1]}°
          `
        }
        else if (item === 35){
          return `
          ...
          ${h10()}
          h1 = ${drobNum("S","a1")} = ${drobNum(task1[0], task1[1])} = ${task1[0]/task1[1]}
          ${h10()}
          ${h10()}
          h2 = ${drobNum("S","a2")} = ${drobNum(task1[0], task1[2])} = ${task1[0]/task1[2]}
          ${h10()}
          ${task1[3] === 1 ? 
            `Большая высота равна: ${task1[0]/task1[2] > task1[0]/task1[1] ? task1[0]/task1[2]:task1[0]/task1[1]}`: 
            `Меньшая высота равна: ${task1[0]/task1[2] < task1[0]/task1[1] ? task1[0]/task1[2]:task1[0]/task1[1]}`} 
          `
        }
        else if (item === 36){
          return `
          Площадь параллелограмма равна: S = a • h
          ${h10()}
          Основание равна: a = ${task1[1]} + ${task1[2]} = ${task1[1]+task1[2]}
          ${h10()} 
          Высота: h = ${task1[3]} 
          ${h10()}
          S = ${task1[1]+task1[2]} • ${task1[3]} = ${(task1[1]+task1[2])*task1[3]}
          `
        }
        else if (item === 37){
          return `
          Сумма углов прилежащих к одной стороне параллелограмма равна 180°.
          ${h10()}
          Меньший угол параллелограмма равен: 180° — ${task1[0]}° = ${180-task1[0]}°
          ${h10()}
          Диагогаль AC делит угол С пополам.
          ${h10()}
          ∠ACD = ∠C / 2 = ${180-task1[0]}° / 2 = ${(180-task1[0])/2}°
          `
        }
        // else if (item === 21){
        //   return `.`
